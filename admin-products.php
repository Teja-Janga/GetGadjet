    ...
    <body>
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center my-3">
                <div>
                    <a href="add-product.php" class="btn btn-success me-2">Add Product</a>
                    <?php if ($showTrashed): ?>
                    ...
                    <?php endif; ?>
                    <a href="index.php" class="btn btn-outline-primary mx-4">🏠 Home</a>
                </div>
                <!-- You can also put filter form here for quick access -->
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered border-secondary align-middle mb-5">
                    <thead class="table-dark">
                        <tr>
                        <th>ID</th><th>Title</th><th>Price</th><th>BrandName</th>
                        <th>Image</th><th>Description</th><th>Featured</th>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <a href="admin-products.php?action=trash&ID=<?= $row['ID'] ?>"
                                        ...
                                        class="btn btn-sm btn-warning mb-1">Trash</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endwhile; ?>
