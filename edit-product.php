...
<html>
    ...
    <div class="container my-5">
        <h2 class="mb-4">Edit Product: <?= htmlspecialchars($product['Title']); ?></h2>
        <form method="post" class="card p-4 border-secondary" style="max-width:540px;">
            <div class="mb-3">
                <label class="form-label">Title</label>
                <input type="text" name="Title" class="form-control border-secondary" value="<?= htmlspecialchars($product['Title']); ?>" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Price</label>
                <input type="number" name="Price" class="form-control border-secondary" value="<?= htmlspecialchars($product['Price']); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Brand Name</label>
                <input type="text" name="BrandName" class="form-control border-secondary" value="<?= htmlspecialchars($product['BrandName']); ?>">
            </div>
            <div class="mb-3">
                <label class="form-label">Image URL</label>
                <input type="text" name="Image" class="form-control border-secondary" value="<?= htmlspecialchars($product['Image']); ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input border-secondary" type="checkbox" name="Featured" id="featuredCheck" <?= $product['Featured'] ? 'checked' : '' ?>>
