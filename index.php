...
<?php
    ...
    // $products = null;
    if ($search == '') {
        $products = mysqli_query($conn, "SELECT * FROM products WHERE Featured = 1");
    } else {
    ...
    <body style="font-family: Arial;">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">    <!-- List Item - 3 -->
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="laptops.php">
                                    Laptops 💻</i></a>
                                </li>
                                <li><a class="dropdown-item" href="phones.php">
                                    Mobile Phones 📱</i></a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="cart.php" class="nav-link">Cart(<?= isset($_SESSION['cart']) ?count($_SESSION['cart']) : 0 ?>)</a>
                        </li>
                    </ul>
        ...
        <div class="container my-4">
            ...
            <form method="GET" action="index.php" class="d-flex justify-content-center">
                <input type="text" name="search" class="form-control w-70 me-2 border-secondary" placeholder="Search products..." value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 d-flex flex-column align-items-center justify-content-center mb-5">
                    <div class="product-img mb-2">
                    <img
                        src="<?= htmlspecialchars($product['Image']); ?>"
                        alt="<?= htmlspecialchars($product['Title']); ?>"
                        class="img-thumbnail"
                        style="width: 270px; height: 100%; object-fit: cover; border-radius:8px;">
                        <!-- style="width: 200px; height: 100%; object-fit: cover; border-radius:8px;" -->
                    </div>
                    <p class="text-center fs-4"><?= htmlspecialchars($product['Title']);?></p>
                    <p class="lprice"><strong>Price: </strong>₹. <?= formatIndianCurrency($product['Price']); ?> /-</p>
